...
router.post('/', function(req, res, next) {         
    // Bambu 게시판에 새로운 글 추가
        ...
        connection.query('INSERT INTO Notice_Board (appID, nickname, content) VALUES (?, ?, ?);',
...
router.post('/:board_id/comment/post', function(req, res, next) {
    connection.query('INSERT INTO Notice_Comment (appID, nickname, content, boardID) VALUES (?, ?, ?, ?);',
