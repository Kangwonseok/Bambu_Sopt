...
router.get('/:board_id', function(req, res, next) {
   ...
   connection.query('SELECT * FROM Thunder_Comment WHERE boardID = ? ORDER BY timestamp desc;', 
...
router.post('/', function(req, res, next) {
        ...
        connection.query('INSERT INTO Thunder_Comment (nickname, content) VALUES (?, ?);', 
                ...
                if (error == null) {
                        ...
                        connection.query('SELECT * FROM Thunder_Comment WHERE boardID = ?;', [info.insertId], function (error, cursor) {
